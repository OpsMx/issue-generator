...
# Package
#pwd
cp -v $BASEDIR/issue-gen/DEBIAN/preinst issue-gen/opt/apps/issue-gen/preinst.sh
cp -v $BASEDIR/issue-gen/DEBIAN/postinst issue-gen/opt/apps/issue-gen/postinst.sh
